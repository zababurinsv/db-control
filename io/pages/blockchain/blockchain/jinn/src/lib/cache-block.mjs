...
debug('[(self)a]', global.PROCESS_NAME)
    ...
    var AllTreeCacheItem = new global.RBTree(function (a,b) {
            return a.ID - b.ID;
        }
    );
    ...
    class CTimeCache
    {
        ...
        constructor(FCompare)
        {
            ...
            this.DataTree = new global.RBTree(FCompare)
            this.TimeTree = new global.RBTree(function (a,b)
            {
        ...
        AddItemToCache(Item)
        {
            if(typeof Item.TimeNum !== "number")
                global.ToLogTrace("Error type Item.TimeNum=" + Item.TimeNum)
