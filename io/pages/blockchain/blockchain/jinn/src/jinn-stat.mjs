...
debug('[(self)a]', global.PROCESS_NAME)
    ...
    var StatKeys = {
        ...
        ReadRowsDB: "Reads",
        WriteRowsDB: "Writes",
        TeraReadRowsDB: "-TReads",
        TeraWriteRowsDB: "-TWrites",
        ReadBlock: "ReadBlock",
        WriteBlock: "WriteBlock",
        ReadBody: "ReadBody",
        WriteBody: "WriteBody",
        MAXChainHeight: "Chains",
        MAXCacheBodyLength: "-CacheB",
        MAXCacheLength: "-Cache",
        CacheErrDB: "CacheErr",
        FindHeadCount: "-FHead",
        MAXFindHeadCount: "MFHead",
        FindEmptyCount: "-FEmpty",
        MAXFindEmptyCount: "MFEmpty",
        HotCount: "Hots",
        MINHots: "-MinHots",
        ActiveCount: "-Connects",
        AddrCount: "Addrs",
        NoValidateTx: 0,
        AddToTreeTx: "-AddTreeTx",
        WasSendOnAddTxToTree: 0,
        NotAddTxToTree: 0,
        ErrorCount: "NetErr",
        MaxReqAll: "-MaxReqAll",
        MaxLoadAll: "-MaxLoadAll",
        MaxReqErr: "-MaxReqErr",
        ...
        ErrProcessBlock: "-ErrProcessBlock",
        SkipMethod: "-SkipMethod",
        TtReceive: "-TtReceive",
        TxReceive: "-TxReceive",
        TxReceiveErr: "-TxReceiveErr",
        BanCount: "-BanCount",
        MainDelta: "MainDelta",
        ErrTt1: "-ErrTt1",
        ErrTt2: "-ErrTt2",
        ...
        TxCache1: "-TxCache1",
        TxCache2: "-TxCache2",
        TxCacheErr: "-TxCacheErr",
        TTTXSend: "-TTTXSend",
        TTTXReceive: "-TtTxReceive",
        ErrTxSend: "-ErrTxSend",
        TXReq: "-TxReq",
        BreakUploadTime: "-BreakUploadTime",
        MinDTransfer: "-MinDTransfer",
        MaxDTransfer: "-MaxDTransfer",
        HeaderLoadOK: "HeaderLoadOK",
        MaxHeaderLoad: "MaxHeaderLoad",
        MaxSendCountItem: "MaxSendCountItem",
    };
    ...
    global.JINN_STAT = JINN_STAT
    JINN_STAT.Methods = {};
    JINN_STAT.Keys = StatKeys;

    global.JINN_STATCopy = {};
    JINN_STAT.Clear = function () {
        global.CopyObjKeys(global.JINN_STATCopy, global.JINN_STAT);
...
//Engine context
    function DoNode(Engine) {
        ...
        var BlockNum = Engine.CurrentBlockNum - global.JINN_CONST.STEP_LAST;
