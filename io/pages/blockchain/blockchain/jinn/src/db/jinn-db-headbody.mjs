...
debug('[(self)a]', global.PROCESS_NAME)
    ...
    class CDBHeadBody
    {
        constructor(name, FormatHead, FormatBody, bReadOnly, ColNumName)
        {
            ...
            this.DBHeader = new global.CDBRow(NameHead, FormatHead, bReadOnly, ColNumName, 10)
            this.DBBody = new global.CDBItem(NameBody, FormatBody, bReadOnly)
        }
   ...
   global.CDBHeadBody = CDBHeadBody
   return CDBHeadBody;
}