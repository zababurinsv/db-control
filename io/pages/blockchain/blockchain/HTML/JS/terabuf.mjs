...
/*
 ...
 var wrk={};
 var Buf=global.SerializeLib.GetBufferFromObject(Data,format,wrk);
 var Data2=global.SerializeLib.GetObjectFromBuffer(Buf,format,wrk);
    ...
    function Write(buf,data,StringFormat,ParamValue,WorkStruct)
    {
        ...
        else
        {
            ...
            switch(format)
            {
                ...
                case "hashSTR":
                {
                    var Str = global.GetHexFromArr(data);
                    WriteStr(buf, Str, 64);
                    break;
                }
                case "uintSTR":
