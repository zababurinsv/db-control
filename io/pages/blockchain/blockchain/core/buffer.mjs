...
export default {
    GetNewBuffer:GetNewBuffer,
    BindBuffer:BindBuffer,

    GetReadBuffer:GetReadBuffer,
    alloc:GetNewBuffer,
    from:GetReadBuffer,
    Write:Write,
    Read:Read,

    GetObjectFromBuffer:GetObjectFromBuffer,
    GetBufferFromObject:GetBufferFromObject,
    GetFormatFromObject:GetFormatFromObject,
