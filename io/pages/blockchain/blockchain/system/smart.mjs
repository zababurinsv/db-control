...
import lexer from '../HTML/JS/lexer.mjs'
import smartVm from "../HTML/JS/smart-vm.mjs"
import SmartTr from "./smart-tr.mjs"
...
debug('[(self)a]', global.PROCESS_NAME)
    ...
    let smartTr = SmartTr(global)
    class SmartApp extends smartTr
    {
        constructor(UpdateVersion)
        {
            ...
            if(fs.existsSync(global.GetDataPath("DB/smart2")) || UpdateVersion=="Update" || !fs.existsSync(global.GetDataPath("DB/smart")))
            {
            ...
            this.DBSmart = new global.CDBRow(FileName, this.FORMAT_ROW, bReadOnly, "Num", DeltaNum, this.ROW_SIZE)
            global.REGISTER_TR_DB(this.DBSmart, FileNameVer)
        ...
        SaveAllToFile()
        {
            ...
            SaveToFile(global.GetDataPath("smart-all.txt"), Str)
        }
        ...
        ClearDataBase()
        {
            ...
            if(global.SHARD_PARAMS.GenesisSmartCreate)
                global.SHARD_PARAMS.GenesisSmartCreate()
            else
        ...
        CreateSmartByParent(Block, BlockNum, TrNum, SmartNum,Params)
        {
            ...
            var Smart2=global.CopyObjKeys({},Smart);
    ...
    global.REGISTER_SYS_DAPP(App, global.TYPE_TRANSACTION_SMART_CREATE1);
    global.REGISTER_SYS_DAPP(App, global.TYPE_TRANSACTION_SMART_RUN1);
    global.REGISTER_SYS_DAPP(App, global.TYPE_TRANSACTION_SMART_CREATE2);
    global.REGISTER_SYS_DAPP(App, global.TYPE_TRANSACTION_SMART_RUN2);
    global.REGISTER_SYS_DAPP(App, global.TYPE_TRANSACTION_SMART_CHANGE);
    global.REGISTER_SYS_DAPP(App, global.TYPE_TRANSACTION_SMART_SET);
