...
debug('[(self)a]', global.PROCESS_NAME)
    ...
    class CDBTree
    {
        constructor(name, format, bReadOnly, CompareFunc, ItemType, TreeType)
        {
            ...
            this.DataWorkStruct = {}
            this.DB = new global.CDBItemFixed(name, commonformat, bReadOnly, 0)
            ...
            if(TreeType === "Bin")
                this.Tree = new global.BinTreeExt(CompareFunc, this.FNode)
            else
                this.Tree = new global.RBTreeExt(CompareFunc, this.FNode)
        ...
        WriteData(Data)
        {
            ...
            var BufWrite = global.SerializeLib.GetBufferFromObject(Data, this.DataFormat, this.DataWorkStruct, 1, [0, 0, 0, 0]);
        ...
        ReadData(Data)
        {
            ...
            try
            {
                Body = global.SerializeLib.GetObjectFromBuffer(BufRead.slice(4), this.DataFormat, this.DataWorkStruct)
            }
            catch(e)
            {
                ToLog("DB-TREE: " + e)
        ...
        WriteRoot()
        {
            ...
            var BufWrite = global.SerializeLib.GetBufferFromObject(RootItem, ROOT_FORMAT, RootWorkStruct, 1);
        ...
        ReadRoot()
        {
            ...
            if(BufRead)
                Item = global.SerializeLib.GetObjectFromBuffer(BufRead, ROOT_FORMAT, RootWorkStruct)
    ...
    global.CDBTree = CDBTree
    return  global.CDBTree ;
