...
//sign support
import accountsAdvMining from "./accounts-adv-mining.mjs"
...
debug('[(self)a]', global.PROCESS_NAME)
    let AccountsAdvMining = accountsAdvMining(global)
    class AccountSign extends AccountsAdvMining
    {
        ...
        CheckSignTransferTx(BlockNum, Body)
        {
            ...
            if(Type === global.TYPE_TRANSACTION_CREATE)
            {
