...
"use strict";
import SmartScroll from "./smart-scroll.mjs"
...
debug('[(self)a]', global.PROCESS_NAME)
    let smartScroll = SmartScroll(global)
    class SmartTR extends smartScroll
    {
        ...
        TRCreateSmart2(Block, Body, BlockNum, TrNum, ContextFrom)
        {
            ...
            var TR = global.SerializeLib.GetObjectFromBuffer(Body, FORMAT_SMART_CREATE2, WorkStructCreate2)
            TR.AccountLength=1;
            TR.TokenGenerate=0;
        ...
        TRCreateSmart1(Block, Body, BlockNum, TrNum, ContextFrom)
        {
            ...
            if(BlockNum < UPDATE_CODE_SHARDING)
                ...
                TR = global.SerializeLib.GetObjectFromBuffer(Body, FORMAT_SMART_CREATE1, WorkStructCreate1)
        ...
        TRRunSmart2(Block, Body, BlockNum, TrNum, ContextFrom)
        {
            ...
            if(ContextFrom)
            {
                TR = global.SerializeLib.GetObjectFromBuffer(Body, FORMAT_SMART_RUN2_NS, WorkStructSmartRun2_NS);
            }
            else
            {
                TR = global.SerializeLib.GetObjectFromBuffer(Body, FORMAT_SMART_RUN2, WorkStructSmartRun2);
        ...
        TRRunSmart1(Block, Body, BlockNum, TrNum, ContextFrom)
        {
            ...
            if(BlockNum < UPDATE_CODE_SHARDING)
                ...
                TR = global.SerializeLib.GetObjectFromBuffer(Body, FORMAT_SMART_RUN1, WorkStructSmartRun1)
            return this.RunSmart(TR,Block, Body, BlockNum, TrNum, ContextFrom);
        }
        ...
        TRChangeSmart(Block, Body, BlockNum, TrNum, ContextFrom)
        {
            ...
            if(BlockNum < UPDATE_CODE_SHARDING)
                ...
                TR = global.SerializeLib.GetObjectFromBuffer(Body, FORMAT_SMART_CHANGE, WorkStructChange)
        ...
        TRSetSmart(Block, Body, BlockNum, TrNum, ContextFrom)
        {
            ...
            var TR=global.SerializeLib.GetObjectFromBuffer(Body, FORMAT_SMART_SET, WorkStructSet);
