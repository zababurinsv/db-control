...
import accountsHistory from "./accounts-history.mjs"
...
debug('[(self)a]', global.PROCESS_NAME)
    let AccountsHistory = accountsHistory(global)
    class AccountAdvMining extends AccountsHistory
    {
    ...
    class CAdvMining
    {
        ...
        InitAMIDTab()
        {
            ...
            this.TreeByID = new global.RBTree(function (a,b)
            {
                return a.ID - b.ID;
            })

            this.TreeByAMID = new global.RBTree(function (a,b)
            {
