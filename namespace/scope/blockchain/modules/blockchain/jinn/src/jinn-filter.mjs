...
//Engine context
    ...
    function InitClass(Engine) {
        ...
        Engine.CanProcessPacket = function (Child, Data) {
            debug(-3,'[(CanProcessPacket*)]', Child.ip)
            if (!Child.IsOpen()) {
                return 0;
            }
            return 1;
        ...
        Engine.StopDoSendPacket = function (Child, Item, Method) {
            ...
            ArrTime[0] = CurTime;
            if (Delta < Item.Period * global.JINN_CONST.MULT_TIME_PERIOD) {
                global.JINN_STAT.SkipMethod++;
        ...
        Engine.AddCheckErrCount = function (Child, Count, StrErr, bSilent) {
            global.JINN_STAT.ErrorCount += Count;
            ...
            if (Child.Score < -global.JINN_CONST.MAX_ERR_PROCESS_COUNT) {
