...
import {config, connectPeers, startIpfs, stopIpfs, testAPIs, waitForPeers} from "/tests/database/orbit-db-test-utils/index.js";
// const rmrf = require('rimraf')
import OrbitDB from "/service/ReactNode/controlCenter/database/modules/orbit-db/dist/index.js";
import mapSeries from "/service/ReactNode/controlCenter/database/modules/p-each-series/dist/index.js";
          ...
          const interval = setInterval(() => {
            if (allReplicated()) {
              ...
              databaseInterfaces.forEach((dbInterface, index) => {
                ...
                console.log('result', result, entryCount)
