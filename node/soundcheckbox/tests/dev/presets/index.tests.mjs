...
export default () => {
    describe(`Positive`, function() {
        ...
        it.skip('create presets', async () => {
            try {
                const data = await req.post('http://localhost:4552/dev/presets', { answer: 42 })
        ...
        it('get presets', async () => {
            try {
                const data = await req.get('http://localhost:4552/dev/presets');
                console.log('DATA', data);
                return  true;
            } catch (error) {
